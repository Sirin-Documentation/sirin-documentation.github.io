...
- Server Features
  ...
  - [Custom Windows](lua/features/customwindow/functionMenu.md#custom-windows-sirin-042)
    ...
    - [Example](lua/features/customwindow/stateFlags.md#custom-window-example)
  ...
  - [Draw Text](lua/features/drawtext.md)
    - [Screen Text](lua/features/drawtext.md#screen-text)
    - [Sidebar Text](lua/features/drawtext.md#sidebar-text)
  ...
  - [Hooks](lua/features/hooks.md#event-hooks)
    - [Using Hooks](lua/features/hooks.md#hooks)
  ...
  - [Modules](lua/features/module.md)
...
- Lua API
  - Hooks
    ...
    - [Character](lua/hooks.md#Character)
    ...
    - [MainThread](lua/hooks.md#MainThread)
    - [Monster](lua/hooks.md#Monster)
    - [PatriarchElect](lua/hooks.md#PatriarchElect)
  ...
  - Threads
    ...
    - [WorldDBThread](lua/threads/WorldDBThread.md)
      - [Sirin](lua/threads/WorldDBThread.md#Sirin)
        ...
        - [mainThread](lua/threads/WorldDBThread.md#SirinmainThread)
    ...
    - [MainThread](lua/threads/MainThread.md)
      - [Sirin](lua/threads/MainThread.md#Sirin)
        ...
        - [mainThread.modNetwork](lua/threads/MainThread.md#SirinmainThreadmodNetwork)
  ...
  - Classes
    ...
    - [CRFNewDatabase](lua/classes/CRFNewDatabase.md)
    - [CRFWorldDatabase](lua/classes/CRFWorldDatabase.md)
    ...
    - [_weeklyguildrank_owner_info](lua/classes/_weeklyguildrank_owner_info.md)
    - [_weeklyguildrank_owner_info___list](lua/classes/_weeklyguildrank_owner_info___list.md)
    - [_worlddb_guild_member_info](lua/classes/_worlddb_guild_member_info.md)
    - [_worlddb_guild_member_info____guild_member_info](lua/classes/_worlddb_guild_member_info____guild_member_info.md)
